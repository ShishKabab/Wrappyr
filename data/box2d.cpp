...
void* b2Sweep__ArrayElement(void* arr, unsigned int idx){
	return &((b2Sweep*)arr)[idx];
}
...
void* b2ContactEdge__ArrayElement(void* arr, unsigned int idx){
	return &((b2ContactEdge*)arr)[idx];
}
...
void* b2BroadPhase__ArrayElement(void* arr, unsigned int idx){
	return &((b2BroadPhase*)arr)[idx];
}
...
void* b2Pair__ArrayElement(void* arr, unsigned int idx){
	return &((b2Pair*)arr)[idx];
}
...
void* b2World__ArrayElement(void* arr, unsigned int idx){
	return &((b2World*)arr)[idx];
}
...
void* b2CircleShape__ArrayElement(void* arr, unsigned int idx){
	return &((b2CircleShape*)arr)[idx];
}
...
void* b2Shape__ArrayElement(void* arr, unsigned int idx){
	return &((b2Shape*)arr)[idx];
}
...
void* b2Draw__ArrayElement(void* arr, unsigned int idx){
	return &((b2Draw*)arr)[idx];
}
...
void* b2BodyDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2BodyDef*)arr)[idx];
}
...
void* b2BodyDef__Get_UserData(void* cls){
	return ((b2BodyDef*)cls)->userData;
}
void b2BodyDef__Set_UserData(void* cls, void* v){
	((b2BodyDef*)cls)->userData = ((void*)v);
}
...
void* b2TimeStep__ArrayElement(void* arr, unsigned int idx){
	return &((b2TimeStep*)arr)[idx];
}
...
void* b2StackEntry__ArrayElement(void* arr, unsigned int idx){
	return &((b2StackEntry*)arr)[idx];
}
char* b2StackEntry__Get_Data(void* cls){
	return ((b2StackEntry*)cls)->data;
}
void b2StackEntry__Set_Data(void* cls, char* v){
	((b2StackEntry*)cls)->data = ((char*)v);
}
...
void* b2Mat22__ArrayElement(void* arr, unsigned int idx){
	return &((b2Mat22*)arr)[idx];
}
...
void* b2TreeNode__ArrayElement(void* arr, unsigned int idx){
	return &((b2TreeNode*)arr)[idx];
}
...
void* b2TreeNode__Get_UserData(void* cls){
	return ((b2TreeNode*)cls)->userData;
}
void b2TreeNode__Set_UserData(void* cls, void* v){
	((b2TreeNode*)cls)->userData = ((void*)v);
}
...
void* b2Color__ArrayElement(void* arr, unsigned int idx){
	return &((b2Color*)arr)[idx];
}
...
void* b2PrismaticJoint__ArrayElement(void* arr, unsigned int idx){
	return &((b2PrismaticJoint*)arr)[idx];
}
...
void* b2RopeJointDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2RopeJointDef*)arr)[idx];
}
...
void* b2EdgeShape__ArrayElement(void* arr, unsigned int idx){
	return &((b2EdgeShape*)arr)[idx];
}
...
void* b2Vec2__ArrayElement(void* arr, unsigned int idx){
	return &((b2Vec2*)arr)[idx];
}
...
void* b2TOIOutput__ArrayElement(void* arr, unsigned int idx){
	return &((b2TOIOutput*)arr)[idx];
}
...
void* b2Contact__ArrayElement(void* arr, unsigned int idx){
	return &((b2Contact*)arr)[idx];
}
...
void* b2ClipVertex__ArrayElement(void* arr, unsigned int idx){
	return &((b2ClipVertex*)arr)[idx];
}
...
void* b2FrictionJointDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2FrictionJointDef*)arr)[idx];
}
...
void* b2Version__ArrayElement(void* arr, unsigned int idx){
	return &((b2Version*)arr)[idx];
}
...
void* b2Timer__ArrayElement(void* arr, unsigned int idx){
	return &((b2Timer*)arr)[idx];
}
...
void* b2DestructionListener__ArrayElement(void* arr, unsigned int idx){
	return &((b2DestructionListener*)arr)[idx];
}
...
void* b2DistanceOutput__ArrayElement(void* arr, unsigned int idx){
	return &((b2DistanceOutput*)arr)[idx];
}
...
void* b2ContactManager__ArrayElement(void* arr, unsigned int idx){
	return &((b2ContactManager*)arr)[idx];
}
...
void* b2Rot__ArrayElement(void* arr, unsigned int idx){
	return &((b2Rot*)arr)[idx];
}
...
void* b2RayCastOutput__ArrayElement(void* arr, unsigned int idx){
	return &((b2RayCastOutput*)arr)[idx];
}
...
void* b2DistanceJointDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2DistanceJointDef*)arr)[idx];
}
...
void* b2Filter__ArrayElement(void* arr, unsigned int idx){
	return &((b2Filter*)arr)[idx];
}
...
void* b2PulleyJoint__ArrayElement(void* arr, unsigned int idx){
	return &((b2PulleyJoint*)arr)[idx];
}
...
void* b2Body__ArrayElement(void* arr, unsigned int idx){
	return &((b2Body*)arr)[idx];
}
...
void* b2SolverData__ArrayElement(void* arr, unsigned int idx){
	return &((b2SolverData*)arr)[idx];
}
...
void* b2WheelJoint__ArrayElement(void* arr, unsigned int idx){
	return &((b2WheelJoint*)arr)[idx];
}
...
void* b2ContactImpulse__ArrayElement(void* arr, unsigned int idx){
	return &((b2ContactImpulse*)arr)[idx];
}
...
void* b2PulleyJointDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2PulleyJointDef*)arr)[idx];
}
...
void* b2TOIInput__ArrayElement(void* arr, unsigned int idx){
	return &((b2TOIInput*)arr)[idx];
}
...
void* b2AABB__ArrayElement(void* arr, unsigned int idx){
	return &((b2AABB*)arr)[idx];
}
...
void* b2Mat33__ArrayElement(void* arr, unsigned int idx){
	return &((b2Mat33*)arr)[idx];
}
...
void* b2RevoluteJoint__ArrayElement(void* arr, unsigned int idx){
	return &((b2RevoluteJoint*)arr)[idx];
}
...
void* b2FixtureProxy__ArrayElement(void* arr, unsigned int idx){
	return &((b2FixtureProxy*)arr)[idx];
}
...
void* b2DynamicTree__ArrayElement(void* arr, unsigned int idx){
	return &((b2DynamicTree*)arr)[idx];
}
...
void* b2RopeDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2RopeDef*)arr)[idx];
}
...
float* b2RopeDef__Get_Masses(void* cls){
	return ((b2RopeDef*)cls)->masses;
}
void b2RopeDef__Set_Masses(void* cls, float* v){
	((b2RopeDef*)cls)->masses = ((float*)v);
}
...
void* b2QueryCallback__ArrayElement(void* arr, unsigned int idx){
	return &((b2QueryCallback*)arr)[idx];
}
...
void* b2DistanceJoint__ArrayElement(void* arr, unsigned int idx){
	return &((b2DistanceJoint*)arr)[idx];
}
...
void* b2MassData__ArrayElement(void* arr, unsigned int idx){
	return &((b2MassData*)arr)[idx];
}
...
void* b2Vec3__ArrayElement(void* arr, unsigned int idx){
	return &((b2Vec3*)arr)[idx];
}
...
void* b2Profile__ArrayElement(void* arr, unsigned int idx){
	return &((b2Profile*)arr)[idx];
}
...
void* b2MouseJointDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2MouseJointDef*)arr)[idx];
}
...
void* b2Position__ArrayElement(void* arr, unsigned int idx){
	return &((b2Position*)arr)[idx];
}
...
void* b2Jacobian__ArrayElement(void* arr, unsigned int idx){
	return &((b2Jacobian*)arr)[idx];
}
...
void* b2DistanceProxy__ArrayElement(void* arr, unsigned int idx){
	return &((b2DistanceProxy*)arr)[idx];
}
...
void* b2RopeJoint__ArrayElement(void* arr, unsigned int idx){
	return &((b2RopeJoint*)arr)[idx];
}
...
void* b2DistanceInput__ArrayElement(void* arr, unsigned int idx){
	return &((b2DistanceInput*)arr)[idx];
}
...
void* b2StackAllocator__ArrayElement(void* arr, unsigned int idx){
	return &((b2StackAllocator*)arr)[idx];
}
...
void* b2WorldManifold__ArrayElement(void* arr, unsigned int idx){
	return &((b2WorldManifold*)arr)[idx];
}
...
void* b2GearJointDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2GearJointDef*)arr)[idx];
}
...
void* b2JointDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2JointDef*)arr)[idx];
}
...
void* b2JointDef__Get_UserData(void* cls){
	return ((b2JointDef*)cls)->userData;
}
void b2JointDef__Set_UserData(void* cls, void* v){
	((b2JointDef*)cls)->userData = ((void*)v);
}
...
void* b2GearJoint__ArrayElement(void* arr, unsigned int idx){
	return &((b2GearJoint*)arr)[idx];
}
...
void* b2ManifoldPoint__ArrayElement(void* arr, unsigned int idx){
	return &((b2ManifoldPoint*)arr)[idx];
}
...
void* b2RevoluteJointDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2RevoluteJointDef*)arr)[idx];
}
...
void* b2Transform__ArrayElement(void* arr, unsigned int idx){
	return &((b2Transform*)arr)[idx];
}
...
void* b2WeldJoint__ArrayElement(void* arr, unsigned int idx){
	return &((b2WeldJoint*)arr)[idx];
}
...
void* b2Fixture__ArrayElement(void* arr, unsigned int idx){
	return &((b2Fixture*)arr)[idx];
}
...
void* b2Manifold__ArrayElement(void* arr, unsigned int idx){
	return &((b2Manifold*)arr)[idx];
}
...
void* b2WeldJointDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2WeldJointDef*)arr)[idx];
}
...
void* b2PrismaticJointDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2PrismaticJointDef*)arr)[idx];
}
...
void* b2RayCastInput__ArrayElement(void* arr, unsigned int idx){
	return &((b2RayCastInput*)arr)[idx];
}
...
void* b2Joint__ArrayElement(void* arr, unsigned int idx){
	return &((b2Joint*)arr)[idx];
}
...
void* b2MouseJoint__ArrayElement(void* arr, unsigned int idx){
	return &((b2MouseJoint*)arr)[idx];
}
...
void* b2ContactFeature__ArrayElement(void* arr, unsigned int idx){
	return &((b2ContactFeature*)arr)[idx];
}
...
void* b2BlockAllocator__ArrayElement(void* arr, unsigned int idx){
	return &((b2BlockAllocator*)arr)[idx];
}
...
void* b2SimplexCache__ArrayElement(void* arr, unsigned int idx){
	return &((b2SimplexCache*)arr)[idx];
}
...
void* b2PolygonShape__ArrayElement(void* arr, unsigned int idx){
	return &((b2PolygonShape*)arr)[idx];
}
...
void* b2JointEdge__ArrayElement(void* arr, unsigned int idx){
	return &((b2JointEdge*)arr)[idx];
}
...
void* b2Velocity__ArrayElement(void* arr, unsigned int idx){
	return &((b2Velocity*)arr)[idx];
}
...
void* b2FrictionJoint__ArrayElement(void* arr, unsigned int idx){
	return &((b2FrictionJoint*)arr)[idx];
}
...
void* b2ContactRegister__ArrayElement(void* arr, unsigned int idx){
	return &((b2ContactRegister*)arr)[idx];
}
...
void* b2ContactFilter__ArrayElement(void* arr, unsigned int idx){
	return &((b2ContactFilter*)arr)[idx];
}
...
void* b2WheelJointDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2WheelJointDef*)arr)[idx];
}
...
void* b2ContactListener__ArrayElement(void* arr, unsigned int idx){
	return &((b2ContactListener*)arr)[idx];
}
...
void* b2RayCastCallback__ArrayElement(void* arr, unsigned int idx){
	return &((b2RayCastCallback*)arr)[idx];
}
...
void* b2LoopShape__ArrayElement(void* arr, unsigned int idx){
	return &((b2LoopShape*)arr)[idx];
}
...
void* b2FixtureDef__ArrayElement(void* arr, unsigned int idx){
	return &((b2FixtureDef*)arr)[idx];
}
...
void* b2FixtureDef__Get_UserData(void* cls){
	return ((b2FixtureDef*)cls)->userData;
}
void b2FixtureDef__Set_UserData(void* cls, void* v){
	((b2FixtureDef*)cls)->userData = ((void*)v);
}
